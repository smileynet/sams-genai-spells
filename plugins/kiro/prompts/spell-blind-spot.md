...
**User checkpoint:** Ask the user about their familiarity level — new, basics, experienced, or skip — to calibrate depth.
...
1. Search for how adjacent fields have dealt with structurally similar problems.
2. Read the most relevant 1-2 results for deeper analysis.
...
1. Search for authentic criticism, documented failures, and substantive dissenting views on the topic.
2. Read the most substantive 1-2 critiques — look for reasoning, not clickbait.
