---
description: Analyze docs for gaps, mixed concerns, and structure
...
- `docs/skills/diataxis-framework.md` — Four-quadrant classification, mixed-quadrant detection, coverage analysis
- `docs/skills/progressive-disclosure-framework.md` — Depth levels, file sizing, navigation assessment
...
Use **AskUserQuestion** to ask: "What docs should I audit?"
Options:
- "The docs/ directory" — Audit project documentation
- "The README and top-level docs" — Audit entry-point documentation
...
Use **Grep** to search for signals: "TODO", "FIXME", "deprecated", "removed", version numbers, dates.
