...
Use **AskUserQuestion** to ask: "What would you like to do with Diataxis?"
Options:
- "Audit existing docs" — Check docs against the four quadrants
- "Restructure existing docs" — Reorganize into Diataxis structure
- "Generate new docs" — Create fresh documentation for a topic
...
Use Glob/Read to scan the documentation:
...
"Here's how I'd restructure your docs into Diataxis quadrants. Does this look right?"
Show which existing content maps to which quadrant and what new content is needed.
...
Use **WebFetch** on the most authoritative results.
Also search the codebase for existing usage patterns.
...
Use **AskUserQuestion** to confirm the plan before generating.
