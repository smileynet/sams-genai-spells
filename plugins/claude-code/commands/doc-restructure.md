---
description: Reorganize docs by purpose and detail level
...
- `docs/skills/diataxis-framework.md` — Four-quadrant classification, directory structure, mixed-quadrant detection
...
Use **Glob** to find all markdown files in `$ARGUMENTS`. Use **Read** to examine each file.
...
Use **AskUserQuestion** to ask: "What docs should I restructure?"
Options:
- "The docs/ directory" — Restructure project documentation
- "A specific subdirectory" — I'll provide the path
...
"Here's how I'd restructure your docs. Does this look right?"
Show the planned structure with what changes — which files stay, split, merge, or move.
