...
Use standard markdown only. Do not use unicode box-drawing characters (═, ━, ┌, ─, etc.). Do not add explanatory text outside the structured sections. Do not use headers or sections not specified in this format.
