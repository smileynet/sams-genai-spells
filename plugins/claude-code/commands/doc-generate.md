...
- `docs/skills/diataxis-framework.md` — Four-quadrant classification, writing rules per quadrant, directory structure
- `docs/skills/progressive-disclosure-framework.md` — Depth levels, file sizing, navigation links
...
Use **AskUserQuestion** to clarify if not obvious from `$ARGUMENTS`:
"Who will read this documentation?"
Options:
- "New users / onboarding" — Need tutorials + getting started, minimal reference
- "Working developers" — Need how-to guides + reference, minimal tutorials
- "Both new and experienced" — Need all quadrants
- "Internal team / maintainers" — Need explanation + reference, architecture focus

**If `$ARGUMENTS` is empty:**
Use **AskUserQuestion** to ask: "What should I create documentation for?"
Options:
- "A topic or concept" — Generate docs from research
- "A codebase area" — Document part of this codebase
- "A feature or API" — Document a specific feature
...
**Web research:**
Use **WebSearch** to research the topic:
- `"<topic> tutorial" OR "getting started"`
- `"<topic> API reference" OR "documentation"`
- `"<topic> architecture" OR "how it works"`

Use **WebFetch** on the most authoritative 1–2 results (official docs, guides).

**Codebase research:**
Use **Glob** and **Grep** to search for:
- Existing docs, README references, inline documentation
- Usage patterns, API signatures, configuration files
...
"Here's the documentation structure I'm planning. Does this look right?"
Show planned files with one-line descriptions and which audience each serves.
