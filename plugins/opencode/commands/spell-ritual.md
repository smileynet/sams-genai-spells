...
Ask the user: "What topic should this ritual analyze?"

### Step 2: Load Ritual Definition

Read the ritual definition file `core/rituals/<ritual-name>.md` from the repository root. If not found, check for a `rituals/` directory that is a sibling to the `commands/` directory.
...
2. **Bridge:** After spell A completes:
   ...
   Present the bridge content and ask the user whether to proceed, modify, skip, or redirect.
