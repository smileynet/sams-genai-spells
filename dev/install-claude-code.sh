  ...
  "plugins": [
    {
      "name": "spell",
      "source": "./spell",
      "description": "Sam's Spells - idiomatic, socratic, bpap, doc-audit, doc-restructure, doc-generate, task-graph, diagnose, cause-map, deep-dive, prior-art, blind-spot, zoom-out, handoff, ritual",
      "version": "$VERSION"
    }
  ]
}
